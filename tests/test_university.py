...
class TestR5(unittest.TestCase):
    ...
    def test_add_timeslot(self):
        self.assertEqual(1, self._uni.add_timeslot("3C", 3, 3))
        self.assertEqual(2, self._uni.add_timeslot("2A", 2, 2))

    def test_book_timeslot(self):
        self._uni.add_timeslot("3C", 3, 3)
        self._uni.book_timeslot(1, 10)
        self.assertEqual(10, self._uni.get_course_in_timeslot(1))

    def test_attend_in_timeslot(self):
        self._uni.add_timeslot("3C", 3, 3)
        self._uni.book_timeslot(1, 10)
        self._uni.attend_in_timeslot(1, 10000)
        self._uni.attend_in_timeslot(1, 10001)
        self.assertEqual({"Chiavassa", "Giusto"}, set(self._uni.get_students_in_timeslot(1)))

    def test_missing_in_timeslot(self):
        self._uni.add_timeslot("3C", 3, 3)
        self._uni.book_timeslot(1, 10)
        self._uni.attend_in_timeslot(1, 10000)
        self.assertEqual({"Giusto"}, set(self._uni.get_missing_students_in_timeslot(1)))
